...
function Lista() {
    ...
    participantes.forEach(participante => {
        ...
        const categoriaNome = participante.cate === '1' ? 'Ouvinte' :
                              participante.cate === '2' ? 'Palestrante' :
                              participante.cate === '3' ? 'Organizador' : 'Desconhecido';

        li.textContent = `${categoriaNome} - Nome: ${participante.nome}, CPF: ${participante.cpf}`;
